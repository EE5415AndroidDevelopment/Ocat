...
public class NewsTvFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_news_tv, container, false);
        recyclerView_tv=(RecyclerView) view.findViewById(R.id.newsTvRecycleView) ;
...
//        }
        ...
        OkHttpUtil.get(Constant.URL_NEWS_TV, new MyCallBack(){
            @Override
...
//            Log.d("testtest",jsonObject.toString());
            final JSONArray array=jsonObject.getJSONArray(Constant.KEY_NEWS_TV);
...
//            });
    ...
    public void onDestroy() {
        super.onDestroy();
        System.out.println("==================NewsTvFragment Destroy===============");
    }
