...
public class NewsEntertainmentFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_news_entertainment, container, false);
        recyclerView_entertainment=(RecyclerView) view.findViewById(R.id.newsEntertainmentRecycleView) ;
        LinearLayoutManager layoutManager=new LinearLayoutManager(getContext());
        recyclerView_entertainment.setLayoutManager(layoutManager);
        GetNews();
        return view;
    }
...
//        }
        ...
        OkHttpUtil.get(Constant.URL_NEWS_ENTERTAINMENT, new MyCallBack(){
            @Override
...
//            Log.d("testtest",jsonObject.toString());
            final JSONArray array=jsonObject.getJSONArray(Constant.KEY_NEWS_ENTERTAINMENT);
